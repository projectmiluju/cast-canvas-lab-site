...
| 레포                                                                                            | 역할                                    |
| ----------------------------------------------------------------------------------------------- | --------------------------------------- |
| [`cast-canvas-lab-orchestrator`](https://github.com/projectmiluju/cast-canvas-lab-orchestrator) | 크로스 레포 계약, 태스크, 컨텍스트 관리 |
| [`cast-canvas-lab-fe`](https://github.com/projectmiluju/cast-canvas-lab-fe)                     | 워크스페이스 프론트엔드                 |
| [`cast-canvas-lab-be`](https://github.com/projectmiluju/cast-canvas-lab-be)                     | 메인 백엔드 API 서버                    |
| [`cast-canvas-lab-collab`](https://github.com/projectmiluju/cast-canvas-lab-collab)             | 실시간 협업 서버                        |
| [`cast-canvas-lab-site`](https://github.com/projectmiluju/cast-canvas-lab-site)                 | 퍼블릭 랜딩 사이트                      |
